...
snapshots['test_sql[ SELECT * EXCLUDE (timestamp_tz) REPLACE (varchar.replace(chr(0), chr(10)) AS whatever) FROM test_all_types() ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
...
snapshots['test_sql[ SELECT * FROM grades grades_parent WHERE grade= (SELECT MIN(grade) FROM grades WHERE grades.course=grades_parent.course); ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[ SELECT * FROM range(10) t1 UNION ALL SELECT * FROM range(5) t2; ] 1'] = '''QueryNodeSubclasses(
    __root__=SetOperationNode(
...
snapshots['test_sql[ SELECT city, COUNT(*) FROM addresses GROUP BY city HAVING COUNT(*) >= 50; ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[ WITH ranked_functions as ( SELECT schema_name, function_name, row_number() over (partition by schema_name order by function_name) as function_rank FROM duckdb_functions() ) SELECT * FROM ranked_functions WHERE function_rank < 3; ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[ select (select 1) as one ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[ select thing[0], thing[\'hello\'], thing[1:3], struct_pack(hello := \'world\').hello, ] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT \'101010\'::BIT] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT \'Math\' IN (\'CS\', \'Math\'), X NOT IN (\'CS\', \'Math\')] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT \'Math\' IN (SELECT course FROM grades);] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT \'hello\' COLLATE NOCASE] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT * FROM frogs USING SAMPLE 1% (BERNOULLI);] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT 0::HUGEINT] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT 0::UNION(num INT, str VARCHAR)] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT 1 < 1, 1 <= 2] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT 2 < 3, 2 > 3, 2 <= 3, 4 >= NULL, NULL = NULL, 2 <> 2] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT 2 IS DISTINCT FROM NULL, NULL IS NOT DISTINCT FROM NULL] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT DATE \'1992-09-20\'] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT EXISTS(SELECT * FROM grades WHERE course=\'Math\');] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT INTERVAL 1 YEAR] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT MIN(COLUMNS(*)), COUNT(COLUMNS(*)) from numbers;] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT NULL IS NULL] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT TIMESTAMP \'1992-09-20 11:30:00\'] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT TIMESTAMPTZ \'1992-09-20 11:30:00\'] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT a BETWEEN x AND y] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT a NOT BETWEEN x AND y] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT a.* FROM (SELECT {\'x\':1, \'y\':2, \'z\':3} as a);] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT expression IS NOT NULL] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[SELECT i, CASE WHEN i>2 THEN 1 ELSE 0 END AS test FROM integers] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select * from duckdb_tables] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select * from range(0, 10)] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select 0::DECIMAL(15, 6)] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select 0::STRUCT(a INT)] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select 0::USER_TYPE] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select 1 * 1] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select 1] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select []::boolean[]] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select frog from frogs where height > 5 and leader = true] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select frog from frogs] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select frog.* EXCLUDE age from frogs] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select frog.age from frogs] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select list_apply([1, 2, 3], x => x * 2)] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
...
snapshots['test_sql[select name from frogs GROUP BY age] 1'] = '''QueryNodeSubclasses(
    __root__=SelectNode(
        type='SELECT_NODE',
        modifiers=[],
        cte_map=CommonTableExpressionMap(map={}),
